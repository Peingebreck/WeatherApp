package com.example.android.weatherapp.data.local.db

import androidx.room.Dao
import androidx.room.Insert
import androidx.room.OnConflictStrategy
import androidx.room.Query
import com.example.android.weatherapp.data.local.model.CityDbModel
...
interface FavouriteCitiesDao {
    ...
    @Query("SELECT EXISTS (SELECT * FROM favourite_cities WHERE id=:cityId)")
