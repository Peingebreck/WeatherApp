package com.example.android.weatherapp.presentation.favourite
...
import com.example.android.weatherapp.domain.usecase.GetCurrentWeatherUseCase
import com.example.android.weatherapp.domain.usecase.GetFavouriteCitiesUseCase
import com.example.android.weatherapp.presentation.favourite.FavouriteStore.Intent
import com.example.android.weatherapp.presentation.favourite.FavouriteStore.Label
import com.example.android.weatherapp.presentation.favourite.FavouriteStore.State
                        ...
                        if (it.city.id == msg.cityId) {
                            it.copy(
                                weatherState = State.WeatherState.Loaded(
                                    msg.tempC, msg.conditionIconUrl
                                )
                            )
                        } else {
                            it
